...
import Debian.Debianize.AtomsClass (HasAtoms(rulesHead, packageDescription), DebAtomKey(..), DebAtom(..))
import Debian.Debianize.AtomsType (Atoms, insertAtom, sourcePackageName, changeLog,
