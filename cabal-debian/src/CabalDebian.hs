...
import Debian.Debianize.Types.Atoms (compilerVersion, dependencyHints)
...
main =
  withFlags $ \ fs ->
      case debAction fs of
        SubstVar debType -> substvars (dryRun fs) (verbosity fs) (compilerVersion fs) (cabalFlagAssignments fs) (dependencyHints (error "Missing DependencyHints atom") fs) debType
